...
class HouseholdDaysimModel(BaseModel):
    ...
    hhftw: int = Field(ge=0, le=99, description="The number of HH members with person type=full-time worker")
    hhptw: int = Field(ge=0, le=99, description="The number of HH members with person type=part-time worker")
    hhret: int = Field(ge=0, le=99, description="The number of HH members with person type=retired adult")
    hhoad: int = Field(ge=0, le=99, description="The number of HH members with person type=other non-working adult")
    hhuni: int = Field(ge=0, le=99, description="The number of HH members with person type=university student")
    hhhsc: int = Field(ge=0, le=99, description="The number of HH members with person type=grade school student age 16+")
    hh515: int = Field(ge=0, le=99, description="The number of HH members with person type=child age 5-15")
    hhcu5: int = Field(ge=0, le=99, description="The number of HH members with person type=child age 0-4")
    hhincome: int = Field(ge=-1, le=9999999, description="The household annual income, in integer dollars")
...
class HouseholdDayDaysimModel(BaseModel):
    ...
    phtours: int = Field(ge=0, le=99, description="The number of partially joint half tour records output")
    fhtours: int = Field(ge=0, le=99, description="The number of fully joint half tour records output")
...
class PersonDayDaysimModel(BaseModel):
    ...
    hbtours: int = Field(ge=0, le=99, description="The total number of home-based tour records predicted")
    wbtours: int = Field(ge=0, le=99, description="The total number of work-based subtour records predicted")
    uwtours: int = Field(ge=0, le=99, description="The total number of home-based work tours to usual workplace")
    wktours: int = Field(ge=0, le=99, description="The number of home-based work tours predicted")
    sctours: int = Field(ge=0, le=99, description="The number of home-based school tours predicted")
    estours: int = Field(ge=0, le=99, description="The number of home-based escort tours predicted")
    pbtours: int = Field(ge=0, le=99, description="The number of home-based personal business tours predicted")
    shtours: int = Field(ge=0, le=99, description="The number of home-based shopping tours predicted")
    mltours: int = Field(ge=0, le=99, description="The number of home-based meal tours predicted")
    sotours: int = Field(ge=0, le=99, description="The number of home-based social tours predicted")
    retours: int = Field(ge=0, le=99, description="The number of home-based recreation tours predicted")
    metours: int = Field(ge=0, le=99, description="The number of home-based medical tours predicted")
    wkstops: int = Field(ge=0, le=99, description="The number of home-based work stops predicted")
    scstops: int = Field(ge=0, le=99, description="The number of home-based school stops predicted")
    esstops: int = Field(ge=0, le=99, description="The number of home-based escort stops predicted")
    pbstops: int = Field(ge=0, le=99, description="The number of home-based personal business stops predicted")
    shstops: int = Field(ge=0, le=99, description="The number of home-based shopping stops predicted")
    mlstops: int = Field(ge=0, le=99, description="The number of home-based meal stops predicted")
    sostops: int = Field(ge=0, le=99, description="The number of home-based social stops predicted")
    restops: int = Field(ge=0, le=99, description="The number of home-based recreation stops predicted")
    mestops: int = Field(ge=0, le=99, description="The number of home-based medical stops predicted")
    wkathome: int = Field(ge=0, le=1439, description="The number of minutes spent working at home during the day")
    pwxcord: float | None = Field(ge=-9999, le=9999, description="Person's work location X coordinate")
    pwycord: float | None = Field(ge=-9999, le=9999, description="Person's work location Y coordinate")
    psxcord: float | None = Field(ge=-9999, le=9999, description="Person's school location X coordinate")
    psycord: float | None = Field(ge=-9999, le=9999, description="Person's school location Y coordinate")
...
class TourDaysimModel(BaseModel):
    ...
    jtindex: int = Field(ge=0, le=99, description="Links to the sequence number of the tour in the JointTour file")
    parent: int = Field(ge=0, le=99, description="The tour sequence number of the parent work tour")
    subtours: int = Field(ge=0, le=99, description="The number of work-based subtours made from the work activity")
    pdpurp: int = Field(ge=1, le=9, description="The tour primary destination purpose")
    tlvorig: int = Field(ge=0, le=1439, description="The time leaving the tour origin, in minutes after midnight")
    tardest: int = Field(ge=0, le=1439, description="The time arriving at the tour destination, in minutes after midnight")
    tlvdest: int = Field(ge=0, le=1439, description="The time leaving the tour destination, in minutes after midnight")
    ...
    phtindx2: int = Field(ge=0, le=99, description="Links to the sequence number of the second half tour in PartialHalfTour")
    fhtindx1: int = Field(ge=0, le=99, description="Links to the sequence number of the first half tour in FullHalfTour")
...
class LinkedTripDaysimModel(BaseModel):
    ...
    opurp: int = Field(ge=0, le=11, description="The purpose at the trip origin")
    dpurp: int = Field(ge=0, le=11, description="The purpose at the trip destination")
