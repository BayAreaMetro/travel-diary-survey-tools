...
class TestUniqueConstraints:
    ...
    def test_unique_passes(self):
        ...
        data.households = pl.DataFrame({
            "hh_id": [1, 2, 3], "home_taz": [100, 200, 300],
    ...
    def test_unique_fails_with_duplicates(self):
        ...
        data = CanonicalData()
        data.households = pl.DataFrame({
            "hh_id": [1, 2, 2], "home_taz": [100, 200, 300],
            "home_lat": [37.7, 37.8, 37.9],
            "home_lon": [-122.4, -122.5, -122.6],
            "income": [50000, 75000, 100000],
            "hh_size": [2, 3, 4], "num_vehicles": [1, 2, 2],
...
class TestForeignKeys:
    ...
    def test_fk_passes(self):
        ...
        data = CanonicalData()
        data.households = pl.DataFrame({
            "hh_id": [1, 2], "home_taz": [100, 200],
            "home_lat": [37.7, 37.8], "home_lon": [-122.4, -122.5],
            "income": [50000, 75000],
            "hh_size": [1, 1], "num_vehicles": [1, 2],
        })
...
class TestRequiredChildren:
    ...
    def test_required_children_fails(self):
        ...
        data.households = pl.DataFrame({
            ...
            "home_lon": [-122.4, -122.5, -122.6],
            "income": [50000, 75000, 100000],
            "hh_size": [1, 1, 1], "num_vehicles": [1, 2, 2],
        })
        data.persons = pl.DataFrame({
            "person_id": [101, 102], "hh_id": [1, 2],
            "age": [6, 8], "gender": ["male", "female"],
