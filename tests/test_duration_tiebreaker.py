    ...
    persons, households, trips = create_test_data([
        {
            ...
            "arrive_time": datetime(2024, 1, 1, 8, 30),  # Arrive at first dest
            "o_lat": 37.7749, "o_lon": -122.4194,  # Home
            "d_lat": 37.7850, "d_lon": -122.4000,  # First destination
        ...
        },
        {
            ...
            "arrive_time": datetime(2024, 1, 1, 9, 30),  # Arrive at 2nd dest
            "o_lat": 37.7850, "o_lon": -122.4000,  # First destination
            "d_lat": 37.7950, "d_lon": -122.4100,  # Second destination
        ...
        },
        {
            ...
            "o_lat": 37.7950, "o_lon": -122.4100,  # Second destination
            "d_lat": 37.7749, "d_lon": -122.4194,  # Home
            "o_purpose_category": PurposeCategory.ERRAND.value,
    ...
    persons, households, trips = create_test_data([
        {
            ...
            "o_lat": 37.7749, "o_lon": -122.4194,  # Home
            "d_lat": 37.7849, "d_lon": -122.4094,  # Work
            "o_purpose_category": PurposeCategory.HOME.value,
        ...
        },
        {
            ...
            "day_id": 1,
            "person_type": PersonType.FULL_TIME_WORKER.value,
            "depart_time": datetime(2024, 1, 1, 9, 0),  # Leave work (30 min)
            "arrive_time": datetime(2024, 1, 1, 9, 30),  # Arrive at shop
            "o_lat": 37.7849, "o_lon": -122.4094,  # Work
            "d_lat": 37.7950, "d_lon": -122.4100,  # Shopping
        ...
        },
        {
            ...
            "day_id": 1,
            "person_type": PersonType.FULL_TIME_WORKER.value,
            "depart_time": datetime(2024, 1, 1, 10, 30),  # Leave shop (60 min)
            "arrive_time": datetime(2024, 1, 1, 11, 0),  # Arrive home
            "o_lat": 37.7950, "o_lon": -122.4100,  # Shopping
            "d_lat": 37.7749, "d_lon": -122.4194,  # Home
