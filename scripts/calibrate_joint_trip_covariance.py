...
def find_candidate_joint_trips(trips: pl.DataFrame) -> pl.DataFrame:
    ...
    logger.info("Found %s likely joint trip pairs", f"{len(likely_joint):,}")
    return likely_joint
...
def _print_dimension_stats(name: str, stats: dict, unit: str) -> None:
    ...
    print(f"\n{name}:")  # noqa: T201
    print(f"  Mean:     {stats['mean']:>8.1f} {unit}")  # noqa: T201
    print(f"  Std Dev:  {stats['std']:>8.1f} {unit}")  # noqa: T201
    print(f"  Variance: {stats['var']:>8.1f} {unit}²")  # noqa: T201
    print(f"  Median:   {stats['median']:>8.1f} {unit}")  # noqa: T201
    print(f"  95th %:   {stats['p95']:>8.1f} {unit}")  # noqa: T201


def _print_header(n_pairs: int) -> None:
    """Print the analysis header."""
    print("\n" + "=" * 70)  # noqa: T201
    print("JOINT TRIP COVARIANCE CALIBRATION ANALYSIS")  # noqa: T201
    print("=" * 70)  # noqa: T201
    print(f"\nAnalyzed {n_pairs:,} likely joint trip pairs")  # noqa: T201
    print(  # noqa: T201
        "\nVariance Analysis "
...
def _print_recommendations(stats: dict) -> None:
    ...
    print("\n" + "=" * 70)  # noqa: T201
    print("RECOMMENDED COVARIANCE DIAGONAL VALUES")  # noqa: T201
    print("=" * 70)  # noqa: T201
    ...
    print("\nBased on observed variance in likely joint trips:")  # noqa: T201
    print(  # noqa: T201
    ...
    print("\nConservative estimate (based on 95th percentile):")  # noqa: T201
    print(  # noqa: T201
    ...
    print("\nCurrent default in code:")  # noqa: T201
    print("  covariance: [7000, 7000, 20, 20]")  # noqa: T201
    print("  (std devs: ~84m, ~84m, ~4.5min, ~4.5min)")  # noqa: T201


def _print_interpretation() -> None:
    """Print interpretation guidance."""
    print("\n" + "=" * 70)  # noqa: T201
    print("INTERPRETATION")  # noqa: T201
    print("=" * 70)  # noqa: T201
    print(  # noqa: T201
        """
...
if __name__ == "__main__":
    ...
    logger.info("Running joint trip detection with buffer method...")
    ...
    logger.info("Saved results to project directory")
