...
=== "households"
    ...
    | Field | Type | Constraints | extract_tours | add_zone_ids | add_existing_weights | format_daysim |
    | --- | --- | --- | --- | --- | --- | --- |
    | `hh_id` | int | ≥ 1, UNIQUE | ✓ | ✓ | ✓ |  |
...
=== "persons"
    ...
    | Field | Type | Constraints | extract_tours | add_zone_ids | add_existing_weights | format_ctramp | format_daysim |
    | --- | --- | --- | --- | --- | --- | --- | --- |
...
=== "days"
    ...
    | Field | Type | Constraints | add_existing_weights | format_daysim |
    | --- | --- | --- | --- | --- |
...
=== "unlinked_trips"
    ...
    | Field | Type | Constraints | link_trips | extract_tours | add_zone_ids | add_existing_weights | format_daysim |
    | --- | --- | --- | --- | --- | --- | --- | --- |
...
=== "linked_trips"
    ...
    | Field | Type | Constraints | detect_joint_trips | extract_tours | add_zone_ids | add_existing_weights | format_ctramp | format_daysim |
    | --- | --- | --- | --- | --- | --- | --- | --- | --- |
    | `day_id` | int | ≥ 1, FK → `days.day_id` |  | ✓ |  |  |  |  |
    | `person_id` | int | ≥ 1, FK → `persons.person_id` |  |  |  |  |  |  |
    | `hh_id` | int | ≥ 1, FK → `households.hh_id` |  |  |  |  |  |  |
...
=== "tours"
    ...
    | Field | Type | Constraints | add_zone_ids | add_existing_weights | format_ctramp | format_daysim |
    | --- | --- | --- | --- | --- | --- | --- |
