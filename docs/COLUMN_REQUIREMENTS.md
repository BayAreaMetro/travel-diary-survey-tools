...
| Table | Field | Type | Constraints | load_data | clean_2023_bats | link_trips | detect_joint_trips | extract_tours | compute_weights | add_zone_ids | format_ctramp | format_daysim | write_data |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
